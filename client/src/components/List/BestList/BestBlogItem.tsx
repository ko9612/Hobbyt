...
export const BLImage = tw.div`aspect-square hidden min-[550px]:block
min-[550px]:w-[6rem] min-[550px]:h-[6rem] sm:w-[7rem] sm:h-[7rem] md:w-[8rem] md:h-[8rem]`;
export const BLContent = tw.div`min-[550px]:px-5 w-full min-[550px]:w-4/5
h-[6rem] sm:h-[7rem] md:h-[8rem] flex flex-col justify-between`;
