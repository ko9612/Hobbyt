    ...
    <>
      ...
      <form className="mb-10" onSubmit={handleSubmit(onSubmit)}>
        <div className="text-center">
          <h2 className="text-MainColor font-bold text-lg sm:text-xl md:text-2xl">
            비밀번호를 잊어버리셨나요?
          </h2>
          <div className="py-5 text-base md:text-lg">
            <p>
            <span className="text-MainColor font-bold mr-2">Hobbyt</span>에 가입했던 이메일을 입력해주세요.
            </p>
        ...
        <p className="py-5 text-sm sm:text-base ">만약 비밀번호를 변경하고 싶지 않거나, 본인이 요청한 것이 아닐 경우, 본 메일은 무시하셔도 됩니다.</p>
      </form>
    </>
  );
}
